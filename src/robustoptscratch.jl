...
N = 10_000
N2 = 1
mean(discounted_reward(simulate(HistoryRecorder(max_steps=10_000), prob, polr, bur)) for i = 1:N)
mean(discounted_reward(simulate(HistoryRecorder(max_steps=1000), prob2, polr2, bur2)) for i = 1:N2)

# Robust point-based value iteration
# POMDP
Plots.plot([0,1], polr.alphas, xticks = 0:0.05:1, lab = polr.action_map, legend = :bottomright)

# Robust point-based value iteration
# RPOMDP
Plots.plot([0,1], polr2.alphas, xticks = 0:0.05:1, lab = polr2.action_map, legend = :bottomright)
